                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($products as $product)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">{{ $product->price }} {{ $product->currency }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            ...
                                            <button onclick="copyToClipboard('{{ route('checkout.show', $product->checkout_link) }}')" class="text-blue-600 hover:text-blue-900 mr-3">Copy Link</button>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="px-6 py-4 whitespace-nowrap text-center text-gray-500">
                                            No products found. <a href="{{ route('admin.products.create') }}" class="text-indigo-600 hover:text-indigo-900">Create one now</a>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
